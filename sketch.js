...
var restart,button,restart_Img,dieSound;
var PLAY = 1;
var END = 0;
var gameState = PLAY;
...
// Creating keys   
    ...
    key3.scale = 0.1
    key4 = createSprite(200,190,20,20);
    ...
    button = createSprite(350,300,50,50);  
    button.addImage(restart_Img);
